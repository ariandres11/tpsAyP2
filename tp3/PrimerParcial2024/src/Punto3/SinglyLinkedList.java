...
public class SinglyLinkedList<E> implements Cloneable {
    ...
    public void addCombineAfter(SinglyLinkedList<E> l) {
        Node<E> walk = head;
        //Node<E> otherWalk = new Node(l.head, null);
        Node<E> otherWalk = l.head;
        Node<E> aux = null;
        Node<E> newest = null;
        while (walk != null && otherWalk != null) {
            newest = new Node<E>(otherWalk.getElement(), walk.getNext());
        ...
        while (otherWalk != null) {
            addLast(otherWalk.getElement());
            otherWalk = otherWalk.getNext();
        }
    }
