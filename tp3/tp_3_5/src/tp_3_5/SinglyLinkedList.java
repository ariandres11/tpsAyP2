...
public class SinglyLinkedList<E> implements Cloneable {
    ...
    /**
     * *
     * Retorna la lista con todos los elementos de la lista pasada combinados después del * primer elemento de la lista. *
     *
     *
     * Por ejemplo: *
     *
     ...
     *
     *
     * @return lista original con todos los elementos de la lista l combinados * después del primer elemento de la lista original *
     *
     *
     */
    public void addCombineAfter(SinglyLinkedList<E> l) {

        //Nodos para recorrer la lista ACTUAL
        Node<E> walk1 = head;
        Node<E> prev = null;

        //Nodo para recorrer la lista l
        Node<E> walk2 = l.head;

        Node<E> newest = null;

        while (walk1 != null && walk2 != null) {
            newest = new Node<E>(walk2.getElement(), walk1.getNext());
        ...
        //Si l es mas larga que la lista original
        while (walk2 != null) {
