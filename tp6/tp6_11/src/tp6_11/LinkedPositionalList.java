...
public class LinkedPositionalList<E> implements PositionalList<E> {
    ...
    public int indexOf(Position<E> p) {
        ...
        //Retorno -1 si no lo encontré en ninguna de las posiciones
        return -1;
    }/*
    11. Extender el TAD PositionalList agregando el método 
    findPosition(e) que retorna la primera posición que contiene 
    un elemento igual a e (o null si no se encuentra). Mostrar cómo implementar
    este método usando solamente otros métodos de la interface PositionalList. */
...
//---------------- nested Node class ----------------
    ...
    /**
     * Node of a doubly linked list, which stores a reference to its element and to both the previous and next node in the list.
     */
...
// instance variables of the LinkedPositionalList
    ...
    /**
     * Returns the given node as a Position, unless it is a sentinel, in which case null is returned (so as not to expose the sentinels to the user).
     */
    ...
    // private utilities
    /**
     * Adds an element to the linked list between the given nodes. The given predecessor and successor should be neighboring each other prior to the call.
     *
    ...
    /**
     * A (nonstatic) inner class. Note well that each instance contains an implicit reference to the containing list, allowing us to call the list's methods directly.
     */
