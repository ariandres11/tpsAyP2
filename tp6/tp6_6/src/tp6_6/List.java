...
public interface List<E> extends Iterable<E> {
     ...
     *
     * @param e Elemento a buscar el indice en la lista
     */
    int indexOf(E e);
     ...
     * lista, o -1 si la lista no contiene el elemento
     *
     * @param e Elemento a buscar el indice la ultima ocurrencia en la lista
     */
    int lastIndexOf(E e);
     ...
     * está presente.
     *
     * @param e Elemento a remover en primera ocurrencia
     */
    boolean remove(E e);
