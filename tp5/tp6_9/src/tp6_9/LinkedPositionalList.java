...
public class LinkedPositionalList<E> implements PositionalList<E> {
  ...
  /**
   * 9. Describir una implementación de los métodos addLast y addBefore de 
   * una lista posicional utilizando solamente métodos del siguiente 
   * conjunto {isEmpty, first, last, before, after, addAfter, addFirst}. 
   */
  ...
  /**NUEVOS ADD LAST Y ADD BEFORE*/
   public Position<E> addLast(E e) {
       if (isEmpty()) { //Si la lista esta vacia es porque es el primer elemento que va a tener
           return addFirst(e);
       }
       //Sino, se agrega el elemento en un  nuevop nodo despues del ultimo nodo
       return addAfter(last(), e);
   
   
   }
   
   //Agrega un elemento antes de una posicion
   public Position<E> addBefore(Position<E> p, E e) throws IllegalArgumentException{
       if (p.equals(first())) { //Si se quiere agregar antes del primero, este pasa a ser el primero
           return addFirst(e);
       }
       //Before devuelve una posicion antes, se coloca el nuevo nodo entre esa posicion y p
