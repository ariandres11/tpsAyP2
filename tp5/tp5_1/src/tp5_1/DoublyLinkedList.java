...
public class DoublyLinkedList<E> {
    ...
    /**
     * Adds an element to the linked list in between the given nodes. The given predecessor and successor should be neighboring each other prior to the call.
     *
