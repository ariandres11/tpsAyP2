...
public class LinkedBinaryTree<E> extends AbstractBinaryTree<E> {
  ...
  public Iterable<Position<E>> replaceAll(E search, E replace){
    ArrayList<Position<E>> ocurrencias = new ArrayList<>();
    for (Position position : positions()){
      if (position.getElement() == search){
        ocurrencias.add(position);
      }
    }
    for (Position position : ocurrencias) {
  ...
  public void createTreeRecursive(Position<E> p, E [] array, int index){
    ...
    if (rightIndex < array.length && array[rightIndex] != null){
      Position<E> rightChild = addLeft(p, array[rightIndex]);
      createTreeRecursive(rightChild, array, leftIndex);
    }
  }
  /**
